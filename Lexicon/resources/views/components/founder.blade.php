        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content">
                    <h1 class="section-title fade-in">Lexicon International School Founder's Message</h1>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="founder-info">
                                    <h2 class="founder-name">Dr. Richard Anderson</h2>
                                    <p class="founder-title">Founder & Chairman of Lexicon International School</p>
                ...
                <div class="col-lg-10">
                    <div class="message-card slide-in-right">
                        <div class="message-content">
                            <h3 class="mb-4" style="color: var(--cool-blue); font-weight: 700;">A Message from Our Founder</h3>
                            ...
                            <div class="mt-4">
                                <strong style="color: var(--text-primary);">Dr. Richard Anderson</strong><br>
                                <em style="color: var(--text-secondary);">Founder & Chairman, Lexicon International School</em>
                            </div>
                        </div>
                    </div>
                </div>
